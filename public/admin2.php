...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($estado === 'rechazado' && empty($observaciones)) {
        ...
        // Actualizar el estado y observaciones del archivo
        ...
        if ($result['pendientes'] == 0) {
            ...
            try {
                ...
                $mail->Password   = 'jqiz xraw yqmm komb';           // Reemplaza con tu App Password o contraseña
...
// Obtener todas las solicitudes junto con la información del alumno
